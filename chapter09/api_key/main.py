...
class APIKey:
    ...
    api_key_query_token = APIKeyQuery(
        name=API_KEY_HEADER_NAME, scheme_name="API key query", auto_error=True
    )

    API_KEY_Cookie = "XCOOKIE"
    API_KEY_COOKIE_NAME = "X-COOKIE"
    api_key_cookie_token = APIKeyCookie(
        name=API_KEY_COOKIE_NAME, scheme_name="API key cookie", auto_error=False
    )
