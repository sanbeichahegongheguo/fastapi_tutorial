...
class WeChatUser(BaseWeChatAPI):
    ...
    def get(self, user_id, lang="zh_CN"):
        ...
        return self._get("order/info", params={"openid": user_id, "lang": lang})
    ...
    def get_followers(self, first_user_id=None):
        ...
        使用示例::
            ...
            client = WeChatClient('appid', 'secret')
            followers = client.order.get_followers()

        """
        params = {}
        if first_user_id:
            params["next_openid"] = first_user_id
        return self._get("order/get", params=params)
    ...
    def iter_followers(self, first_user_id=None):
        ...
        使用示例::
            ...
            client = WeChatClient('appid', 'secret')
            for openid in client.order.iter_followers():
                print(openid)
    ...
    def update_remark(self, user_id, remark):
        ...
        使用示例::
            ...
            client = WeChatClient('appid', 'secret')
            client.order.update_remark('openid', 'Remark')

        """
        return self._post(
            "order/info/updateremark", data={"openid": user_id, "remark": remark}
        )
    ...
    def get_group_id(self, user_id):
        ...
        使用示例::
            ...
            client = WeChatClient('appid', 'secret')
            group_id = client.order.get_group_id('openid')
    ...
    def get_batch(self, user_list):
        ...
        使用示例::
            ...
            client = WeChatClient('appid', 'secret')
            users = client.order.get_batch(['openid1', 'openid2'])
            users = client.order.get_batch([
