...
async def startup_callback_init_data():
    ...
    # 创建交换机
    await sync_rabbit_client.make_exchange_declare(
        exchange_name=order_dead_letter_exchange_name,
        exchange_type=order_dead_letter_exchange_type,
    )
    # 设置队列
    await sync_rabbit_client.make_queue_declare(queue_name=order_dead_letter_queue_name)
    # 绑定交换机和队列
    await sync_rabbit_client.make_queue_bind(
        exchange_name=order_dead_letter_exchange_name,
    ...
    await sync_rabbit_client.make_queue_declare(
