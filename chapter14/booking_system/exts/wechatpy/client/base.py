...
from exts.wechatpy.utils import json, get_querystring
from exts.wechatpy.session.memorystorage import MemoryStorage
from exts.wechatpy.exceptions import WeChatClientException, APILimitedException
...
class BaseWeChatClient(object):
    ...
    def _get(self, url, **kwargs):
        warnings.warn(
            "`_get` method of `WeChatClient` is deprecated, will be removed in 1.6,"
            "Use `get` instead",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def _post(self, url, **kwargs):
        warnings.warn(
            "`_post` method of `WeChatClient` is deprecated, will be removed in 1.6,"
            "Use `post` instead",
            DeprecationWarning,
            stacklevel=2,
        )
